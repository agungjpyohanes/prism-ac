...
\* \*\*Lini Flexo:\*\* Label mesin expose diubah menjadi `rip\_pos` (RIP POS).

\* \*\*Lini Screen:\*\* Pemetaan data tipe screen disesuaikan langsung dengan kolom database `screen\_type`.
